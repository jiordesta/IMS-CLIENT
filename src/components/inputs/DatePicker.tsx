  ...
  return (
    <div ref={ref} className="relative text-c4 w-full">
      ...
      <input
        ...
        className="w-full rounded-lg cursor-pointer bg-c1 border-none outline-none focus:ring-0 text-center py-1"
      />

      {/* Calendar */}
      {open && (
        <div className="absolute bg-c1 rounded-lg shadow-lg mt-2 p-4 z-50 w-full">
          {/* Month Navigation */}
