      ...
      <div className="flex gap-2 justify-start items-center w-full h-full">
        ...
        {add && (
          <button className="cursor-pointer" onClick={add}>
            <img src="/icons/add.svg" width={30} alt="" />
          </button>
        )}
        {done && (
          <button className="cursor-pointer" onClick={done}>
            <img src="/icons/done.svg" width={30} alt="" />
          </button>
        )}
        {inputUnits && (
          <button className="cursor-pointer" onClick={inputUnits}>
            <img src="/icons/input.svg" width={30} alt="" />
          </button>
        )}
        {del && (
          <button className="cursor-pointer" onClick={del}>
            <img src="/icons/delete.svg" width={30} alt="" />
          </button>
        )}
        {edit && (
